        ...
        <div className='lg:w-1/4 lg:h-3/4 flex flex-col justify-evenly items-center rounded-xl bg-[#CDEA68]'>
          ...
          <form
            ...
            <div className='relative z-0 lg:w-60 md:w-60 sm:w-60 mb-5 group'>
              ...
              <label
                htmlFor='email'
                className={`peer-focus:font-medium absolute text-sm text-zinc-900 dark:text-zinc-900 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-zinc-900 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 ${
            ...
            <div className='relative z-0 lg:w-60 md:w-60 sm:w-60 mb-5 group'>
              ...
              <label
                htmlFor='password'
                className={`peer-focus:font-medium absolute text-sm text-zinc-900 dark:text-zinc-900 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-zinc-900 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 ${
          ...
          <Link to='/signup' className='text-zinc-900'>
