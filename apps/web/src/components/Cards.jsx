const theme = {
  ...
  cardText:
    "absolute lg:px-5 lg:py-1 sm:text-sm rounded-full lg:border-2 lg:left-5 lg:bottom-10 sm:left-2 sm:bottom-5 text-white font-display",
};
    ...
    <div className="w-full h-screen bg-zinc-900 lg:flex items-center lg:px-32 sm:p-20 gap-5 border-b border-zinc-700">
      ...
      <div className={` ${theme.cardContainer} flex gap-5`}>
        ...
        <div className={`${theme.card} bg-[#212121]`}>
          <img
            className="w-32"
            src="/img/social/thefutureacadmy.png"
